...
The proposal that was shot down in ~2010 by mst iirc was:

 owned_by / maybe_owned_by

 maybe_owns_one / owns_one / owns_many

While less clear on the *referential* part, it is very clear on the *direction*
part, and imo is clearer to a non-DB person.
